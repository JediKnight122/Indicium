...
namespace Detective {
	...
	constexpr static uint8_t maxRandomQuotes = 6;
	string actionBoxElemente[15] = {};
	string actionTextLog;
	string hintLines[maxRandomQuotes]{ "Ich bin mir sicher, dass es nicht ", "Gestern Abend waren ","Ich habe einen Hinweis für Sie: ", "Ich hatte zu dem Zeitpunkt schönes Gespräch mit ", "Ich glaube, dass ", "Detective! " };
	string hintLinesPart2[maxRandomQuotes]{ " war!" ," und ich essen."," habe ich zum Zeitpunkt des Mordes in der Küche gesehen.", " Wir haben uns gut verstanden!", " gestern Abend jemandem im Billardraum nachspioniert hat!", " hat gestern Abend eine Stunde lang die Toilette besetzt!" };
	...
	private:
		void Indict(int susNr) {
			...
			if (gameManager->CheckIfIsMurder(susNr)) {
				ClearActionLog();
				AddNewLineToActionLog("Hervorragende Arbeit! Du hast den Mordfall aufgeklaert und den Verbrecher gefunden.\nWeiter so, beim nächsten Mordfall werden wir uns wieder an Sie wenden!\n\n...Beende Verbindung.");
			}
			else {
				ClearActionLog();
	...
	public:
		...
		void EnterRoom(int roomNr) {
			...
			if (iPeopleInRoom==0) AddNewLineToActionLog("Es befinden sich keine Verdächtigen "+ gameManager->GetRoomPraeposition(roomNr) +" "+ gameManager->GetRoomName(roomNr)+".\n");
				...
				for (int i = 0; i < iPeopleInRoom; i++)
				{
					int iRandomQuote = gameManager->GenerateRandomNumber(0, maxRandomQuotes);
					AddNewLineToActionLog(gameManager->GetPersonName(roomNr, i) + ": " + hintLines[iRandomQuote] + gameManager->GetAlibiName(roomNr, i) + hintLinesPart2[iRandomQuote] + "\n");
				}
				AddNewLineToActionLog("\n");
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ActionFeed->Font = (gcnew System::Drawing::Font(L"Courier New", 16.25F));
			...
			this->ActionFeed->Size = System::Drawing::Size(499, 488);
			...
			this->panel3->Location = System::Drawing::Point(1190, 92);
			...
			this->Sbutton_Hausmeister->Size = System::Drawing::Size(204, 208);
			...
			this->Sbutton_baronin->Size = System::Drawing::Size(201, 217);
			...
			this->Sbutton_frau_wiesental->Size = System::Drawing::Size(207, 208);
			...
			this->Sbutton_oberst->Size = System::Drawing::Size(207, 208);
			...
			this->Sbutton_anton->Size = System::Drawing::Size(207, 208);
			...
			this->Sbutton_reverend->Size = System::Drawing::Size(207, 207);
			...
			this->Sbutton_frau_weiss->Size = System::Drawing::Size(207, 217);
			...
			this->checkedListBox1->Font = (gcnew System::Drawing::Font(L"Courier New", 21, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			...
			this->checkedListBox1->Size = System::Drawing::Size(421, 242);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Courier New", 26.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
